"""Início — visão geral da plataforma e status das conexões."""
from __future__ import annotations

import streamlit as st

from components.ui import fmt_br
...
st.markdown(
    ...
    <style>
      ...
      .hero-sub { font-size: 1rem; opacity:.7; margin-top:.35rem; max-width: 640px; }
      .status-pill {
      ...
      .feat-card p  { font-size:.85rem; opacity:.75; line-height:1.45; margin:0; }
    </style>
    """,
...
if not bedrock_ok:
    ...
    st.success("Tudo pronto. Comece pelo Chat Analítico:", icon="✅")
    st.page_link("views/chat.py", label="Abrir Chat Analítico", icon=":material/forum:")
